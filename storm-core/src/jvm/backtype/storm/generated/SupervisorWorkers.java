          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.workers = new ArrayList<WorkerSummary>(_list162.size);
              for (int _i163 = 0; _i163 < _list162.size; ++_i163)
              {
                WorkerSummary _elem164; // required
                _elem164 = new WorkerSummary();
                _elem164.read(iprot);
                this.workers.add(_elem164);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.workers != null) {
      oprot.writeFieldBegin(WORKERS_FIELD_DESC);
      {
        ...
        for (WorkerSummary _iter165 : this.workers)
        {
