...
public class Nimbus {
  ...
  public interface Iface {
    ...
    public String getSupervisorConf(String id) throws AuthorizationException, org.apache.thrift.TException;

    public ClusterSummary getClusterInfo() throws AuthorizationException, org.apache.thrift.TException;

    public SupervisorWorkers getSupervisorWorkers(String id) throws NotAliveException, AuthorizationException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getSupervisorConf(String id, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getSupervisorConf_call> resultHandler) throws org.apache.thrift.TException;
    ...
    public void getSupervisorWorkers(String id, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getSupervisorWorkers_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String getSupervisorConf(String id) throws AuthorizationException, org.apache.thrift.TException
    {
      send_getSupervisorConf(id);
      return recv_getSupervisorConf();
    }

    public void send_getSupervisorConf(String id) throws org.apache.thrift.TException
    {
      getSupervisorConf_args args = new getSupervisorConf_args();
      args.set_id(id);
      sendBase("getSupervisorConf", args);
    }

    public String recv_getSupervisorConf() throws AuthorizationException, org.apache.thrift.TException
    {
      getSupervisorConf_result result = new getSupervisorConf_result();
      receiveBase(result, "getSupervisorConf");
      if (result.is_set_success()) {
        return result.success;
      }
      if (result.aze != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getSupervisorConf failed: unknown result");
    }
    ...
    public SupervisorWorkers getSupervisorWorkers(String id) throws NotAliveException, AuthorizationException, org.apache.thrift.TException
    {
      send_getSupervisorWorkers(id);
      return recv_getSupervisorWorkers();
    }

    public void send_getSupervisorWorkers(String id) throws org.apache.thrift.TException
    {
    ...
    public SupervisorWorkers recv_getSupervisorWorkers() throws NotAliveException, AuthorizationException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getSupervisorConf(String id, org.apache.thrift.async.AsyncMethodCallback<getSupervisorConf_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getSupervisorConf_call method_call = new getSupervisorConf_call(id, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getSupervisorConf_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String id;
      public getSupervisorConf_call(String id, org.apache.thrift.async.AsyncMethodCallback<getSupervisorConf_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getSupervisorConf", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getSupervisorConf_args args = new getSupervisorConf_args();
        args.set_id(id);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public String getResult() throws AuthorizationException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getSupervisorConf();
      }
    }
    ...
    public void getSupervisorWorkers(String id, org.apache.thrift.async.AsyncMethodCallback<getSupervisorWorkers_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getSupervisorWorkers_call method_call = new getSupervisorWorkers_call(id, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getSupervisorWorkers_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String id;
      public getSupervisorWorkers_call(String id, org.apache.thrift.async.AsyncMethodCallback<getSupervisorWorkers_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
      ...
      public SupervisorWorkers getResult() throws NotAliveException, AuthorizationException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getSupervisorConf", new getSupervisorConf());
    ...
    private static class getSupervisorConf<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getSupervisorConf_args> {
      public getSupervisorConf() {
        super("getSupervisorConf");
      }

      protected getSupervisorConf_args getEmptyArgsInstance() {
        return new getSupervisorConf_args();
      }

      protected getSupervisorConf_result getResult(I iface, getSupervisorConf_args args) throws org.apache.thrift.TException {
        getSupervisorConf_result result = new getSupervisorConf_result();
        try {
          result.success = iface.getSupervisorConf(args.id);
        } catch (AuthorizationException aze) {
          result.aze = aze;
        }
        return result;
    ...
    private static class getSupervisorWorkers<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getSupervisorWorkers_args> {
      ...
      protected getSupervisorWorkers_result getResult(I iface, getSupervisorWorkers_args args) throws org.apache.thrift.TException {
        getSupervisorWorkers_result result = new getSupervisorWorkers_result();
        try {
          result.success = iface.getSupervisorWorkers(args.id);
        } catch (NotAliveException e) {
          result.e = e;
        } catch (AuthorizationException aze) {
          result.aze = aze;
...
;
  ...
  public static class getSupervisorConf_args implements org.apache.thrift.TBase<getSupervisorConf_args, getSupervisorConf_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getSupervisorConf_args");
    ...
    static {
      ...
      tmpMap.put(_Fields.ID, new org.apache.thrift.meta_data.FieldMetaData("id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getSupervisorConf_args.class, metaDataMap);
    }

    public getSupervisorConf_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getSupervisorConf_args(getSupervisorConf_args other) {
      if (other.is_set_id()) {
        this.id = other.id;
      }
    }

    public getSupervisorConf_args deepCopy() {
      return new getSupervisorConf_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getSupervisorConf_args)
        return this.equals((getSupervisorConf_args)that);
      return false;
    }

    public boolean equals(getSupervisorConf_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getSupervisorConf_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getSupervisorConf_args typedOther = (getSupervisorConf_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSupervisorConf_args(");
      boolean first = true;
  ...
  public static class getSupervisorConf_result implements org.apache.thrift.TBase<getSupervisorConf_result, getSupervisorConf_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getSupervisorConf_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.AZE, new org.apache.thrift.meta_data.FieldMetaData("aze", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getSupervisorConf_result.class, metaDataMap);
    }

    public getSupervisorConf_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getSupervisorConf_result(getSupervisorConf_result other) {
      if (other.is_set_success()) {
        this.success = other.success;
      }
      if (other.is_set_aze()) {
    ...
    public getSupervisorConf_result deepCopy() {
      return new getSupervisorConf_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getSupervisorConf_result)
        return this.equals((getSupervisorConf_result)that);
      return false;
    }

    public boolean equals(getSupervisorConf_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getSupervisorConf_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getSupervisorConf_result typedOther = (getSupervisorConf_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSupervisorConf_result(");
      boolean first = true;
